...
#                OpenBCIBoard(port=port, isSimulator=True)

#obci = open_bci.OpenBCIBoard(args.serial, int(args.baud), isSimulator=True)
obci = open_bci.OpenBCIBoard(port="/dev/ttyUSB", isSimulator=True)
if args.filter_data:
